...
> = ({className, children, side = 'right', ...props}) => {
    return (
        <SheetPortal>
            ...
            >
                {children}
                <BaseDialog.Close className="ring-offset-background focus:ring-ring data-[open]:bg-secondary absolute top-4 right-4 opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none">
