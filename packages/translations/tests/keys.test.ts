...
describe('key generator', () => {
    test('generates keys with scope and path', () => {
    ...
    test('generates same hash for same text', () => {
    ...
    test('generates common keys for shared strings', () => {
